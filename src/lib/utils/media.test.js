...
describe('media utils', () => {
	...
	it('enforces count limit', () => {
		const files = Array.from({length: MAX_ATTACHMENTS+1}, (_,i)=> makeFile(`f${i}.jpg`,'image/jpeg',100));
	...
	it('optimizes image buffer', async () => {
		...
		const pngData = Buffer.from('iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR4nGP4BwQACfsD/Qq9YpEAAAAASUVORK5CYII=','base64');
